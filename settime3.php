...
<body background="image/5372533847_eb3cf5815e_m.jpg" onload="MM_preloadImages('image/buttons/ss.PNG','image/buttons/tt.PNG','image/buttons/mm.PNG','image/buttons/s011.PNG','image/buttons/s022.PNG','image/buttons/d5.PNG')">
<div align="center">
  ...
  <br>
  <span class="mycss" id="showNowtime">(現在時間)</span>
  <span class="mycss"><br>
  ...
  <span class="mycss" id="showAlarmtime" name="showAlarmtime">(排程時間)</span><br>
   ...
   <form name="wateringschedule" id="wateringschedule" action="weblogin/b1.php" METHOD="POST">
     <p><div id="calltab" onmousedown="tab()"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image9','','image/buttons/s011.PNG',1)"><img src="image/buttons/s01.PNG" width="226" height="99" id="Image9" /></a></div></p>
     <p>
       ...
       <input type="text" size="5" name="newalarmtime" id="newalarmtime" readonly style="display:none">
     </p>
	 <p>
...
?>
  <tr>
    ...
    <td><?php echo rtrim(rtrim($rs[2], '0'), '.');?></td>
	<td><img src="image/buttons/d3.PNG" width="79" height="45" onclick="TestF(<?php echo $rs[0]?>);" /></td>
  </tr>
